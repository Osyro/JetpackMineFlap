...
function choseCharacter(){
  ...
  if (characterDecision == 1) {
    ...
    chosenCharacter = "Images/Character1Steve.png";
    chosenCharacterFlying = "Images/Character1SteveFlying.png";
    document.getElementById("characterchosen").innerHTML = "Your character is the Steve Skin from Minecraft";
  }
  else{
